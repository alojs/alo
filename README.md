...
* Core: https://cdn.rawgit.com/alojs/alo/v2.8.1/dist/alo.dev.js
* Full: https://cdn.rawgit.com/alojs/alo/v2.8.1/dist/alo.full.dev.js

#### Production (minified)

* Core: https://cdn.rawgit.com/alojs/alo/v2.8.1/dist/alo.min.js
* Full: https://cdn.rawgit.com/alojs/alo/v2.8.1/dist/alo.full.min.js

#### More?
Please have a look at [RawGit](https://rawgit.com). It allows you to use basically any file from Github repos (and therefore also all the files from https://cdn.rawgit.com/alojs/alo/v2.8.1/dist/)
