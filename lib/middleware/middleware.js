...
import Customizer from './../util/customizer.js'

var u = new Util()

var customizer = new Customizer(true)
var middlewareRelation = new ObjectRelation('middleware', 'parentMiddleware', function () {
...
var storeRelation = new ObjectRelation('middleware', 'store', function () {
