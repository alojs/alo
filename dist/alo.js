(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define('alo', factory) :
	(global.Alo = factory());
...
Util.prototype.createAlo = function createAlo () {
  var alo = Object.create(Alo$1.prototype);
  Alo$1.apply(alo, arguments);
  return alo
};
...
Alo$1.prototype.createSubscription = function createSubscription () {
...
Alo$1.prototype.isSubscription = function isSubscription (subscription) {
  return (subscription instanceof Subscription)
};

Alo$1.prototype.createDependency = function createDependency () {
...
Alo$1.prototype.isDependency = function isDependency (dependency) {
  return (dependency instanceof Dependency)
};

Alo$1.prototype.createMember = function createMember () {
...
Alo$1.prototype.isMember = function isMember (member) {
 ...
 * @see Reducer
 */
Alo$1.prototype.createReducer = function createReducer () {
 ...
 */
Alo$1.prototype.isReducer = function isReducer (reducer) {
 ...
 * @see Store
 */
Alo$1.prototype.createStore = function createStore () {
 ...
 */
Alo$1.prototype.isStore = function isStore (store, validateId) {
...
Alo$1.prototype.isMiddleware = function isMiddleware (middleware) {
  return (middleware instanceof Middleware)
};

Alo$1.prototype.createMiddleware = function createMiddleware () {
